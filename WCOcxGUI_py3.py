...
class MyApp( wx.App ): 
    ...
    def OnClick(self,e):
        ...
        print(pixelxsize, pixelysize, exposure)
        ...
        f.create_dataset("image", data = np.array(data).reshape(600,800))
        f.close()
        df = pd.DataFrame(np.array(data).reshape(600,800))
    ...
    def __init__( self, redirect=False, filename=None ):
        ...
        self.ti = wx.TextCtrl(bp, value=r"C:\Users\zzp\Desktop\RailAbberation", pos=(30, 115), size=(170, -1))
